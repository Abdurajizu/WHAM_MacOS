...
def run(cfg,
    ...
    with torch.no_grad():
        if not (osp.exists(osp.join(output_pth, 'tracking_results.pth')) and 
            ...
            detector = DetectionModel(cfg.DEVICE.lower(), backend=detector_backend)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--detector_backend', type=str, default='auto',
                        choices=['auto', 'vitpose', 'yolo_pose'],
                        help='2D detector backend')
